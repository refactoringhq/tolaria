...
export function frontmatterHighlightTheme(isDarkMode = false) {
  void isDarkMode
  return EditorView.baseTheme({
    '.cm-frontmatter-delimiter': { color: 'var(--accent-red)', fontWeight: '600' },
    '.cm-frontmatter-key': { color: 'var(--accent-red)' },
    '.cm-frontmatter-value': { color: 'var(--accent-green)' },
  })
}

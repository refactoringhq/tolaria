...
function explicitSwitchCommands({
  ...
  return AI_AGENT_DEFINITIONS
    ...
    .map((definition) => ({
      ...
      keywords: ['ai', 'agent', 'default', 'switch', 'claude', 'codex', 'pi', definition.shortLabel.toLowerCase()],
      enabled: true,
  ...
  return [
    {
      ...
      group: 'Settings',
      keywords: ['ai', 'agent', 'guidance', 'restore', 'repair', 'claude', 'codex', 'pi', 'agents'],
      enabled: true,
...
export function buildAiAgentCommands({
  ...
  const commands: CommandAction[] = [
    {
      ...
      group: 'Settings',
      keywords: ['ai', 'agent', 'agents', 'assistant', 'claude', 'codex', 'pi', 'settings'],
  ...
  commands.push({
    ...
    group: 'Settings',
    keywords: ['ai', 'agent', 'default', 'switch', 'claude', 'codex', 'pi'],
